...
public:
    ...
    void ChangePhoneNumber(string& sname, string& fname, string& pname, string& country_c, string& city_c, string& number, string add = "") {
...
int main()
{
    Person p("John", "Smith", "Paul");
    cout << p;

    PhoneNumber pn(7, 910, "1234567");
    cout << pn << "\n\n";

    PhoneBook book("phb.txt");
    cout << book;
    cout << "\n\n";
    ...
    auto au = book.GetPhoneNumber("Sokolov");
    cout << get<0>(au) << " ";
    auto au1 = get<1>(au);
    cout << au1 << endl;
    ...
    book.ChangePhoneNumber(sname, fname, pname, country_code, city_code, number);
    cout << book;
    cout << "\n\n";
